...
export const InstanceCardSkeleton = () => {
    return (
      <div className='relative flex  min-w-[255px] h-[375px] flex-col items-center justify-start gap-y-4 animate-pulse rounded-md border-4 border-zinc-200 bg-zinc-300 p-4 font-semibold shadow-md transition duration-200 ease-in hover:z-[99] hover:scale-125 hover:shadow-2xl dark:border-zinc-800 dark:bg-zinc-700'>
